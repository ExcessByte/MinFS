...
!(function (t) {
	...
	var l,
		...
		h =
			...
			o(l, "duotone", "Duotone"),
			o(l, "sharp", "Sharp"),
			o(l, "sharp-duotone", "Sharp Duotone"),
			o(l, "chisel", "Chisel"),
			o(l, "etch", "Etch"),
			o(l, "graphite", "Graphite"),
			o(l, "jelly", "Jelly"),
			o(l, "jelly-duo", "Jelly Duo"),
			o(l, "jelly-fill", "Jelly Fill"),
			o(l, "mosaic", "Mosaic"),
			o(l, "notdog", "Notdog"),
			o(l, "notdog-duo", "Notdog Duo"),
			o(l, "pixel", "Pixel"),
			o(l, "slab", "Slab"),
			o(l, "slab-duo", "Slab Duo"),
			o(l, "slab-press", "Slab Press"),
			o(l, "slab-press-duo", "Slab Press Duo"),
			o(l, "thumbprint", "Thumbprint"),
			o(l, "utility", "Utility"),
			o(l, "utility-duo", "Utility Duo"),
			o(l, "utility-fill", "Utility Fill"),
			o(l, "vellum", "Vellum"),
			o(l, "whiteboard", "Whiteboard"),
		...
		v =
			...
			o(c, "pixel", "Pixel"),
			o(c, "slab", "Slab"),
			o(c, "slab-duo", "Slab Duo"),
			o(c, "slab-press", "Slab Press"),
			o(c, "slab-press-duo", "Slab Press Duo"),
	...
	function _(t) {
		...
		C(a, o) || ("fulfilled" === n && D(a, o), "rejected" === n && I(a, o));
	}
	function C(t, e) {
		var o;
		try {
	...
	function U(t, e) {
		"pending" === t._state &&
			((t._state = "settled"), (t._data = e), k(L, t));
	}
	function I(t, e) {
		"pending" === t._state &&
			((t._state = "settled"), (t._data = e), k(N, t));
	}
	function T(t) {
		t._then = t._then.forEach(_);
	}
	function L(t) {
	...
	((K.prototype = {
		...
		then: function (t, e) {
			...
			return (
				(!e && !t) ||
					this._handled ||
					((this._handled = !0),
					"rejected" === this._state && P && k(M, this)),
		...
		(K.resolve = function (t) {
			return t && "object" === n(t) && t.constructor === K
				? t
				: new K(function (e) {
						e(t);
					});
	...
	var R = "function" == typeof Promise ? Promise : K;
	function J(t, e) {
		var n = e.fetch,
			o = e.XMLHttpRequest,
			r = e.token,
		...
		return (
			r &&
				...
				("URLSearchParams" in window
					? (a = new URL(t)).searchParams.set("token", r)
					: (a = a + "?token=" + encodeURIComponent(r))),
			(a = a.toString()),
			new R(function (t, e) {
				if ("function" == typeof n)
					n(a, { mode: "cors", cache: "default" })
						.then(function (t) {
	...
	function H(t, n) {
		...
		if (
			(i
				? l.push({ id: "fa-main", addOn: void 0, url: i })
				: l.push({
						id: "fa-main",
						addOn: void 0,
						url: j(t, {
			...
			var s =
					t.customIconsCssPath.indexOf("kit-upload.css") > -1
						? t.baseUrlKit
						: t.baseUrl,
				c = s + "/" + t.customIconsCssPath;
			l.push({ id: "fa-kit-upload", url: c });
		}
		var u = l.map(function (o) {
			return new R(function (r, a) {
				var i =
						o.url ||
						j(t, { addOn: o.addOn, minify: t.minify.enabled }),
					l = { id: o.id },
					s = t.subset
						? l
						: e(
	...
	function B(t) {
		...
		(a ||
			o.addEventListener(
				...
				(e = function () {
					for (
						o.removeEventListener("DOMContentLoaded", e), a = 1;
						(e = n.shift());
					)
						e();
				}),
	...
	try {
		if (window.FontAwesomeKitConfig) {
			var W = window.FontAwesomeKitConfig,
				Y = {
					detectingConflicts:
						W.detectConflictsUntil &&
						new Date() <= new Date(W.detectConflictsUntil),
			...
			(function () {
				...
				.then(function (t) {
					(t.map(function (t) {
						try {
							Q.insertBefore(t, $ ? $.nextSibling : null);
						} catch (e) {
							Q.appendChild(t);
						}
					}),
						Y.detectingConflicts &&
							$ &&
							B(function () {
								$.setAttributeNode(
									document.createAttribute(
										Y.detectionIgnoreAttr,
									),
								);
								var t = (function (t, e) {
									var n = document.createElement("script");
